...
import ru.falikk.mediasearch.dao.EntryDao;
...
public class ParserAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (entry.isYoutube())
            ((ImageView) view.findViewById(R.id.item_img)).setImageResource(R.drawable.yt);
        else
            ((ImageView) view.findViewById(R.id.item_img)).setImageResource(R.drawable.vk);
